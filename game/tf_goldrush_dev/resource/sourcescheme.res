...
Scheme
{
	Colors
	{
	    "TFDarkBrown"               "66 62 59 255"
	    "TFDarkBrownTransparent"    "66 62 59 190"
	    "TFTanBright"               "251 236 203 150"
	    "TFTanLight"                "163 153 133 255"
	    "TFTanMedium"               "104 97 84 255"
		...
		"SelectionBG"		"180 81 14 255"	// background color of any selected text or menu item
		"SelectionBG2"		"181 92 33 180"	// selection background in window w/o focus
		"ListBG"			"43 40 38 255"		// background of server browser, buddy list, etc.
	}
	BaseSettings
	{
		...
		Button.TextColor				"TFTextDark"
		Button.BgColor					"TFTanLight"
		Button.ArmedTextColor			"TFTextDark"
		Button.ArmedBgColor				"TFTanBright"
		Button.DepressedTextColor		"TFTextDark"
		...
		ListPanel.SelectedTextColor			"TFTextBlack"
		...
		SectionedListPanel.SelectedTextColor			"TFTextBlack"
		SectionedListPanel.SelectedBgColor				"SelectionBG"
		SectionedListPanel.OutOfFocusSelectedTextColor	"TFTextBlack"
		...
		TextEntry.SelectedTextColor	        "TFTextBlack"
